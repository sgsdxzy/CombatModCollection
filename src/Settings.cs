...
namespace CombatModCollection
{
    public class Settings : AttributeSettings<Settings>
    {
        ...
        [SettingPropertyBool(displayName: "Enable", Order = 0, RequireRestart = true, HintText = "Enable SendAllTroops.")]
        ...
        [SettingPropertyBool(displayName: "Enable", Order = 0, RequireRestart = true, HintText = "Enable WarStomp.")]
        ...
        [SettingPropertyBool(displayName: "Enable", Order = 0, RequireRestart = true, HintText = "Enable PowerThrust. The total magnitude = kE * (0.5 * weight * speed^2) + kP * (weight * speed) + kC.")]
        ...
        [SettingPropertyBool(displayName: "Enable", Order = 0, RequireRestart = true, HintText = "Enable RealisticBallistics.")]
        ...
        [SettingPropertyBool(displayName: "Enable", Order = 0, RequireRestart = true, HintText = "Enable ModifyRespawnParty.")]
        ...
        [SettingPropertyBool(displayName: "Enable", Order = 0, RequireRestart = true, HintText = "Enable LearnToQuit.")]
        [SettingPropertyGroup("LearnToQuit")]
        public bool Strategy_LearnToQuit { get; set; } = false;

        [SettingPropertyFloatingInteger(displayName: "Retreat Chance Multiplier", minValue: 0f, maxValue: 5f, Order = 0, RequireRestart = false, HintText = "Multiplier to the chance of successful retreat.")]
        [SettingPropertyGroup("LearnToQuit")]
        ...
        [SettingPropertyBool(displayName: "Enable", Order = 0, RequireRestart = true, HintText = "Enable BanditMerger.")]
